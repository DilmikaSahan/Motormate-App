...
namespace Motormate {
	...
	/// <summary>
	/// Summary for adminHistory
	/// </summary>
	public ref class adminHistory : public System::Windows::Forms::Form
	{
	public:
		adminHistory(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(adminHistory::typeid));
			...
			this->dataGridView1->Location = System::Drawing::Point(8, 136);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->Size = System::Drawing::Size(869, 394);
			this->dataGridView1->TabIndex = 16;
			this->dataGridView1->CellContentClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &adminHistory::dataGridView1_CellContentClick);
			// 
			// adminHistory
			// 
			...
			this->Name = L"adminHistory";
			this->Text = L"ServiceHistory";
			this->Load += gcnew System::EventHandler(this, &adminHistory::adminHistory_Load);
...
private: void LoadServiceHistory() {
	...
	try {
		...
		String^ query =
			"SELECT sh.HistoryID, sh.BookingID, b.VehicleNumber, b.VehicleType, " +
			"s.PackageName, sh.ServiceDate, sh.Notes, sh.Status, u.FullName " +
			"FROM ServiceHistory sh " +
			"JOIN Bookings b ON sh.BookingID = b.BookingID " +
			"JOIN ServicePackages s ON b.PackageID = s.PackageID " +
			"JOIN Users u ON b.UserID = u.UserID " +
			"WHERE sh.Status IN ('Canceled', 'Completed')";
	...
	private: System::Void adminHistory_Load(System::Object^ sender, System::EventArgs^ e) {
		LoadServiceHistory();
}
};
}
